...
- Добавлен механизм выгрузки агрегированных данных по вакансиям в формате JSON (по аналогии с котировками, сохраняется в /data/python/vacancies/).
...
```
/data/python/vacancies/{SYMBOL}.json
[
  {
    "id": "...",
    "name": "...",
...
```
// Пример функции
public static function saveVacanciesAsJson(array $vacancies, string $symbol, string $targetDir = '/data/python/vacancies/') {
